...
export default function Horoscope() {
  ...
  return (
    <div className="horoscope">
      ...
      <div className="top-zodiac-buttons">
        {horoscope[0].color ? (
          <HoroscopeReading horoscope={horoscope} />
        ) : (
          <p></p>
        )}
      </div>
